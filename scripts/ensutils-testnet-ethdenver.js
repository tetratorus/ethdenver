...
var ethRegistrar = auctionRegistrarContract.at('0x0');
ens.owner(namehash('eth'), (err, res) => {
  if (err) {
...
var testRegistrar = fifsRegistrarContract.at('0x0');
ens.owner(namehash('test'), (err, res) => {
  if (err) {
    console.log('Error:', err)
    return
  }
  testRegistrar = fifsRegistrarContract.at(res)
})
...
var reverseRegistrar = reverseRegistrarContract.at('0x0');
ens.owner(namehash('addr.reverse'), (err, res) => {
  if (err) {
    console.log('Error:', err)
    return
  }
  reverseRegistrar = reverseRegistrarContract.at(res)
})
